  ...
  const fetchTrends = useCallback(async () => {
    ...
    try {
      const [trendsRes, historyRes] = await Promise.all([
        axios.get(`${API_URL}/api/v1/weather/trends`, {
